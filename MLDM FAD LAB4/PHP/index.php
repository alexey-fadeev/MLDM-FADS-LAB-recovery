...
<body>
	...
	<div class="container">
		<form action="/index.php" method="post">
			<textarea  cols="40" rows="15" class="area" name="textfield" placeholder="Введите матрицу графа" ></textarea>
			<div>
				 Найти путь из вершины <input type = "text" name = "first" size = "1"> в вершину <input type = "text" name = "second" size = "1"><br>
			</div>
